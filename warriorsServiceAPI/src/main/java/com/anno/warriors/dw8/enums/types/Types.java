...
public enum Types implements DW8Enumeration<Types> {
	...
	BOMB("Bomb"), SHORT_PIKE("Short Pike"), GREAT_AXES("Great Axes"), MACE("Mace"), SPIKED_SHIELD("Spiked Shield"),
	...
	STRIKING_SWORD("Striking Sword"), TAILSMAN_CARDS("Tailsman Cards"), FLAIL_SWORD("Flail Sword"),
